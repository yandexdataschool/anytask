...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.gitlab_integrated'
        db.add_column(u'courses_course', 'gitlab_integrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.gitlab_integrated'
        db.delete_column(u'courses_course', 'gitlab_integrated')
